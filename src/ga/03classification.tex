...
The operation of composition is necessary in order to define inverses of maps.
...
\br
In \Cref{rem:natural_numbers_modern_form}, we presented a modern definition
...
\mapsto m + S(a) := S(m + a).$ This definition is not used in this text.
\er

\be
We have:
\bse
2+1=S^1(2)=S(S^0(2))=S(2)=3
\ese
and:
\bse
